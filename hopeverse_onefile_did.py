...
@dataclass
class Settings:
    app_name: str = os.getenv("APP_NAME", "HOPEverse")
...
<body>
  <nav class="nav">
    <div class="container nav-inner">
      <div class="brand">HOPE<span>tensor</span></div>
      <div class="nav-links">
  ...
  <header class="hero">
    <div class="container hero-grid">
      <div>
        <div class="eyebrow">Civilization Operating System • Powered by HOPEtensor</div>
        <h1>
  ...
  <section id="roadmap">
    <div class="container">
      <div class="section-head">
        <h2>2035 Roadmap</h2>
        <p>
          2035 is the first irreversible checkpoint: HOPEtensor remains the execution core, while HOPEverse expands into trust, identity, governance, and full civilization coordination.
        </p>
      </div>
      <div class="roadmap">
        <div class="card">
  ...
  <footer>
    <div class="container">
      HOPEverse — Civilization Operating System powered by HOPEtensor
    </div>
  </footer>
